...
\begin{itemize}
  \item to provide an exhaustive list of segmentation methodologies that have been developed for delineating breast lesions in \us images.
  \item to collect a set of terms that facilitate placing each work with respect of the rest of the \stateArt.
  \item to provide an overview of how each methodology has been assessed.
  \item to clarify assessment assumptions that influence a fair results comparison.
\end{itemize}

A secondary objective of the authors, but equally essential to us, is
\begin{itemize}
  \item to ensure comprehensive coverage of the available segmentation methodologies.
  \item fair treatment.
  \item reusability of the efforts put in this article.
\end{itemize}
}
